...
public class ProductDetailsListAdapter extends BaseAdapter {
    ...
    public ProductDetailsListAdapter(Context context, List<ProductItemType1> rowItem,RelativeLayout cartBottom) {
        ...
        if (cartBottom != null)
        {
            this.cartBottomLayout =  cartBottom;

            //cart size count indicator
            cartBadgeCount = (TextView) cartBottomLayout.findViewById(R.id.cart_count);
            cartValueText=(TextView)cartBottomLayout.findViewById(R.id.total_cart_amount);

        }
        cartSize = SharedPreferencesHelper.getNumCartItemsSharedPref(context);
        cartVal = SharedPreferencesHelper.getValCartItemsSharedPref(context);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.btn_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cartVal+=Integer.valueOf(row_pos.getOurPrice());
                //update the shared prefs for new cart value
                SharedPreferencesHelper.setValCartItemsSharedPref(context, cartVal);

                //increment the number of cart size only for unique item added to cart
                if(nCartItems==1) {
                    cartSize++;
                    ...
                    //remove the bottom cart display
                ...
                cartBadgeCount.setText(String.valueOf(cartSize));

                if (cartValueText!=null)
                    cartValueText.setText(String.valueOf(cartVal));
